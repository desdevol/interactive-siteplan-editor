<template>
  <div class="project-site-plan-editor-map">
    <div id="site-plan-map" :style="{ width: '100%', height: '100%' }"></div>
  </div>
</template>
...
import { getPolygonStyleByStatus } from "@/modules/Project/store/sitePlanEditor";
  ...
  methods: {
    ...
    addListeners(layer) {
      layer.on("click", () => {
        ...
        // Select Layer
        layer.setStyle({ color: "#3388ff", fillOpacity: "0.8", fill: true });
